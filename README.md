...
- 0 vous ramenera au menu principal.
...
- 0 vous ramenera au menu de l'employé.
...
Aquarium 1 propre, salinté: 10, profondeur: 2
...
- 0 vous ramenera au menu enclos.
...
## 4.2 Validation (depuis _menu tranférer animal_)
...
L'animalMathilde fait son entrée dans l'enclos Voliere 1
