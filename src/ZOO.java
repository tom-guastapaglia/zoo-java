...
public class ZOO {
    ...
    public static void main(String[] args) {
        ...
        Aigle aigle = new Aigle(1, "Albert", true, 6, 2, 8, false, false, false,0, 43);
        Aigle aigle1 = new Aigle(2, "Sophie", false, 4, 1, 6, false, false, false, 0,43);

        Baleine baleine = new Baleine(3,"Marcel", true, 150000, 30, 123, false, false, true, 0,420);
        Baleine baleine1 = new Baleine(4,"Mathilde", false, 120000, 25, 99, false, false, true, 0,420);

        Loup loup = new Loup(5,"Robert", true, 123, 2, 12, false, false, true, 0,62);
        Loup loup1 = new Loup(6,"Jade", false, 99, 1, 11, false, false, true,0, 62);

        Ours ours = new Ours(7,"Leo", true, 500, 2, 15, false, false, true, 0,200);
        Ours ours1 = new Ours(8,"Clemence", false, 400, 1, 12, false, false, true, 0,200);

        Pingouin pingouin = new Pingouin(9,"Lucas", true, 1, 1, 5, false, false, true, 0,67);
        Pingouin pingouin1 = new Pingouin(10,"Emy", false, 2, 1, 6, false, false, true, 0,67);

        PoissonRouge poissonRouge = new PoissonRouge(11,"Nemo", true, 1, 1, 6, false, false, true, 0,5);
        PoissonRouge poissonRouge1 = new PoissonRouge(12,"Dory", false, 1, 1, 5, false, false, true,0, 5);

        Requin requin = new Requin(13,"Bruce", true, 5000, 12, 50, false, false, true, 0,90);
        Requin requin1 = new Requin(14,"Martine", false, 4000, 10, 45, false, false, true, 0,90);

        Tigre tigre = new Tigre(15,"Paul", true, 150, 3, 5, false, false, true, 0,100);
        Tigre tigre1 = new Tigre(16,"Cerise", false, 120, 2, 6, false, false, true, 0,100);
